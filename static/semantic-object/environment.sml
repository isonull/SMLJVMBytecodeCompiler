structure Environment = struct
  ...
  fun strenvAugment (ENV (se, te, ve)) se' =
    ENV (SE.unionWith #2 (se, se'), te, ve)

  fun tyenvAugment (ENV (se, te, ve)) te' =
    ENV (se, TE.unionWith #2 (te, te'), ve)

  fun valenvAugment (ENV (se, te, ve)) ve' =
    ENV (se, te, VE.unionWith #2 (ve, ve'))
